...
{
	/* The pool is configured entirely through the constructor options array
	 * (connect() is rejected in pool mode), so the loopback default below is
	 * always overridden by `opts` whenever a host was supplied. */
